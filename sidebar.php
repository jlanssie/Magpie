<div id="sidebar">
	<div class="socialShare">
		<div>
			<a href="http://www.facebook.com/sharer.php?u=<?php global $wp; echo home_url( $wp->request )?>" target="_blank">
		...
		<div>
			<a href="https://twitter.com/share?url=<?php global $wp; echo home_url( $wp->request )?>" target="_blank">
		...
		<div>
			<a href="http://reddit.com/submit?url=<?php global $wp; echo home_url( $wp->request )?>" target="_blank">
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
		...
		<div>
			<a href="mailto:?Subject=<?php echo get_bloginfo('name'); ?>&amp;Body=Check%20out%20this%20website:%20<?php global $wp; echo home_url( $wp->request )?>" target="_blank">
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
